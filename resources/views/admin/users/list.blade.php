                    ...
                    <div class="table-responsive--md  table-responsive">
                        <table class="table table--light style--two">
                            ...
                            <tr>
                                ...
                                <td>
                                    {{ \App\Models\User::getUserTypeName($user->user_type) }}
                                </td>

                                <td>

                                @php $referedByUser = \App\Models\User::with('referrer')->find($user->id)->referrer; 
                                @endphp
                                    {{ !empty($user->referrer)?($referedByUser->user_type=='AGENT' ? 'AGENT':$referedByUser->firstname." ".$referedByUser->lastname):'Bzone24' }}
                                </td>
                                <td>
