            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Type')
                            <span class="fw-bold">{{ __(\App\Models\Withdrawal::getTypeName($withdrawal->type)) }}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
                            <span class="fw-bold">{{__($withdrawal->method? $withdrawal->method->name : "-")}}</span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Amount')
                ...
                <form action="{{ route('admin.withdraw.data.approve') }}" method="POST">
                    ...
                    <div class="modal-body">
                        <p>@lang('Have you sent') <span
                                class="fw-bold text--success">{{ showAmount($withdrawal->final_amount,currencyFormat:false) }} {{$withdrawal->currency}}</span>?
                        </p>
                ...
                <form action="{{route('admin.withdraw.data.reject')}}" method="POST">
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <textarea name="details" class="form-control" rows="3" value="{{ old('details') }}"
                                      required></textarea>
                        </div>
                    </div>
                    <div class="modal-footer">
