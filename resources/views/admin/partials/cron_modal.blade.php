                ...
                <div class="cron-modal-header">
                    <div class="modal-header-top">
                        <h5 class="modal-title" id="exampleModalLongTitle"><i
                                class="las la-calendar text--primary"></i> @lang('Please Set Cron Job') </h5>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <button type="button" class="input-group-text copy-text-btn copyCronPath text--primary"><i
                                class="fas fa-copy"></i> <span class="copyText text--primary">@lang('Copy')</span>
                        </button>
                    </div>
                </div>
                <div class="justify-content-between cron-btn-group d-flex gap-2">
                    <a href="{{ route('admin.cron.index') }}" class="btn btn-outline--primary  w-100 h-45"><i
                            class="fas fa-cog"></i> @lang('Cron Job Setting')</a>
                    <a href="{{ route('cron') }}?target=all" class="btn btn-outline--warning w-100 h-45"><i
                            class="fas fa-bolt"></i> @lang('Run Manually')</a>
                </div>
            </div>
        </div>
    </div>
