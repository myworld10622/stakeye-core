...
@section('panel')
    ...
    <div class="row gy-4 mt-2">
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                style="5"
                link="{{ route('admin.report.lottery.ticket') }}"
                icon="las la-money-bill"
                title="Sold Tickets"
                value="{{ $widget['sold_ticket'] }}"
                bg="primary"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                ...
                title="Sold Amounts"
                value="{{ showAmount($widget['sold_amount']) }}"
                bg="warning"
            />
        </div><!-- dashboard-w1 end -->
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                style="5"
                link="{{ route('admin.report.winners') }}"
                icon="las la-medal"
                title="Winners"
        ...
        <div class="col-xxl-3 col-lg-4 col-sm-6">
            <x-widget
                ...
                title="Win Amounts"
                value="{{ showAmount($widget['win_bonus']) }}"
                bg="3"
            />
        </div><!-- dashboard-w1 end -->
