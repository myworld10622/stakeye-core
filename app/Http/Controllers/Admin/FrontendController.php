...
class FrontendController extends Controller
{
    ...
    public function BannerIndex(){
        ...
        return view('admin.banners.index', compact('pageTitle','sliders', 'categories'));
    }
    ...
    public function BannerCreate()
    {
        ...
        $categories = HomeBanner::categories();
        return view('admin.banners.create', compact('pageTitle','categories'));
    }
     ...
     public function BannerStore(Request $request)
    {
        $validated = $request->validate([
            ...
            'players_count' => 'nullable|integer',
            'is_active' => 'boolean',
        ...
        // Handle image upload
        if ($request->hasFile('image')) {
            $filename = fileUploader($request->image, getFilePath('lottery'), getFileSize('lottery'));
            $validated['image_path'] =$filename;
        }

        HomeBanner::create($validated);

        return redirect()->route('admin.frontend.banner.index')
    ...
    public function BannerEdit($id)
    {
        ...
        $categories = HomeBanner::categories();
        return view('admin.banners.edit', compact('pageTitle','slider', 'categories'));
    }
