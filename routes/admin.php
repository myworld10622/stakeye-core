...
Route::middleware('admin')->group(function () {
    Route::controller('AdminController')->group(function(){
        ...
        Route::any('manage-rewards/{id?}', 'manageRewards')->name('mange-rewards');
        Route::any('reward-users/{id}', 'rewardUsers')->name('reward-users');
        Route::any('update-status/{id}', 'rewardUpdateStatus')->name('reward-update-status');
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function(){
        ...
        Route::get('wins/{id}', 'wins')->name('wins');
        Route::get('tickets/{id}', 'tickets')->name('tickets');
        Route::get('referrals/{id}', 'referrals')->name('referrals');

        Route::get('commissions/deposit/{id}', 'referralCommissionsDeposit')->name('commissions.deposit');
        Route::get('commissions/buy/{id}', 'referralCommissionsBuy')->name('commissions.buy');
        Route::get('commissions/win/{id}', 'referralCommissionsWin')->name('commissions.win');
    });
    ...
    Route::controller('ReportController')->prefix('report')->name('report.')->group(function(){
        ...
        // Sold Ticket
        Route::get('lottery/tickets', 'tickets')->name('lottery.ticket');
    });
    ...
    Route::controller('SystemController')->name('system.')->prefix('system')->group(function(){
     ...
     Route::controller('GameController')->name('games.')->prefix('games')->group(function(){ 
        Route::get('game-list','gameList')->name('list');
        Route::post('status/{id}', 'status')->name('status');
    });
    ...
    Route::name('frontend.')->prefix('frontend')->group(function () {
        ...
        Route::controller('FrontendController')->group(function(){
            ...
            Route::post('remove/{id}', 'remove')->name('remove');
            Route::get('list', 'BannerIndex')->name('banner.index');
            Route::get('create', 'BannerCreate')->name('banner.create');
            Route::post('store', 'BannerStore')->name('banner.store');
            Route::get('edit/{id}', 'BannerEdit')->name('banner.edit');
            Route::get('update/{id}', 'BannerUpdate')->name('banner.update.form');
            Route::put('update/{id}', 'BannerUpdate')->name('banner.update');
            Route::delete('delete/{id}', 'BannerDestroy')->name('banner.delete');
        });
    ...
    Route::controller('LotteryController')->name('lottery.')->prefix('lottery')->group(function(){
        ...
        // Bonus
        Route::get('win/bonus/{id}', 'winBonus')->name('win.bonus');
        Route::post('win/bonus/bonus', 'bonus')->name('bonus');
    ...
    // Draw Lottery
    Route::controller('DrawController')->prefix('lottery/draw')->name('lottery.draw.')->group(function () {
        Route::get('/', 'manual')->name('manual');
        Route::get('/{id}', 'findTicket')->name('find');
        Route::post('win/{id}', 'draw')->name('win');
    });
